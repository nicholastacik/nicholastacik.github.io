...
- `Elizabeth` -> `Elizabeth Barrett Browning`
- `Burns` -> `Robert Burns`
- `Milton` -> `John Milton`
- `Thomas` -> `Dylan Thomas`
- `England` -> `New England`
...
- `George` -> `George Washington Carver`
...
## era 2020, cluster 5
- `Olympics` -> `Olympic`
- `American` -> `National Museum of African American History`
...
- `France` -> `Tour de France`
- `Cleveland` -> `Cleveland Cavaliers`
- `Canadian` -> `Canadian Football League`
- `Aaron` -> `Hank Aaron`
- `Braves` -> `Atlanta Braves`
- `Atlanta` -> `Atlanta Braves`
- `Joe` -> `Joe Namath`
...
- `Christian` -> `Christian Dior`
- `Brit` -> `Brits`
- `Paul` -> `Jean Paul Gaultier`
- `Edwardian` -> `Edwardian Era`

## era 2020, cluster 9
- `American` -> `American Express`
- `Americans` -> `American Express`
- `America` -> `Bank of America`
- `Wall Street` -> `Wall Street Journal`
- `Jack` -> `Jack Dorsey`
...
- `Asia` -> `Southeast Asia`
- `Africa` -> `South Africa`
- `Kentucky` -> `Bluegrass Country of Kentucky`
...
- `American` -> `American Airlines`
- `New York` -> `New York City`
- `Smithsonian` -> `Smithsonian National Air`
- `Royce` -> `Rolls Royce`
...
- `Latin` -> `the Latin`
- `Greek` -> `the Greek`
- `Americans` -> `American Cancer Society`
...
- `French` -> `Old French`
- `Romans` -> `Roman`
- `Earth` -> `Enclosed Earth`
- `British` -> `British Thermal Unit`
- `Britain` -> `Great Britain`
- `Avenue` -> `Massachusetts Avenue Bridge`
